		...
		<Dialog open>
			<DialogContent className="bg-white dark:bg-[#313338] text-black dark:text-white p-0 overflow-hidden">
				<DialogHeader className="pt-8 px-6">
					...
					<DialogDescription className="text-center text-zinc-500 dark:text-zinc-50">
				...
				<Form {...form}>
					<form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
						...
						<DialogFooter className="bg-white dark:bg-[#313338] text-black dark:text-white px-6 py-4">
